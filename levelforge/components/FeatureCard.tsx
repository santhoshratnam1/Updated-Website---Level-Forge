...
export const FeatureCard: React.FC<FeatureCardProps> = ({ 
  ...
  return (
    <GlassCard 
      hover3d 
      className="p-8 cursor-pointer group h-full bg-[#0a0a0a] border-white/5 hover:border-blue-500/20 transition-all duration-300"
      style={{
    ...
    >
      ...
      <div className="relative mb-6 w-fit">
        ...
        {/* Icon container */}
        <div className={`relative p-4 rounded-2xl bg-white/5 border border-white/10 group-hover:border-blue-500/30 transition-all duration-300`}>
          <Icon name={icon} className="w-8 h-8 text-gray-400 group-hover:text-blue-400 transition-colors duration-300" />
        </div>
      </div>
